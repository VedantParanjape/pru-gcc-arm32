...
#define HAVE_ATTR_alu2_zext_subst 1
extern enum attr_alu2_zext_subst get_attr_alu2_zext_subst (rtx_insn *);

#define HAVE_ATTR_alu3_zext_op1_subst 1
extern enum attr_alu3_zext_op1_subst get_attr_alu3_zext_op1_subst (rtx_insn *);

#define HAVE_ATTR_alu3_zext_op2_subst 1
extern enum attr_alu3_zext_op2_subst get_attr_alu3_zext_op2_subst (rtx_insn *);

#define HAVE_ATTR_alu3_zext_subst 1
extern enum attr_alu3_zext_subst get_attr_alu3_zext_subst (rtx_insn *);

#define HAVE_ATTR_bitalu_zext_subst 1
extern enum attr_bitalu_zext_subst get_attr_bitalu_zext_subst (rtx_insn *);
