...
#endif
#ifdef GENERATOR_FILE
extern enum pru_abi pru_current_abi;
#else
  enum pru_abi x_pru_current_abi;
#define pru_current_abi global_options.x_pru_current_abi
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  const char *x_VAR_mmcu_;
#define x_VAR_mmcu_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mno_relax;
#define x_VAR_mno_relax do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_MINRT (1U << 0)
#define MASK_OPT_LOOP (1U << 1)

#define TARGET_MINRT ((target_flags & MASK_MINRT) != 0)
#define TARGET_MINRT_P(target_flags) (((target_flags) & MASK_MINRT) != 0)
#define TARGET_OPT_LOOP ((target_flags & MASK_OPT_LOOP) != 0)
#define TARGET_OPT_LOOP_P(target_flags) (((target_flags) & MASK_OPT_LOOP) != 0)
...
enum opt_code
{
  ...
  OPT_list = 1594,                           /* -list */
  OPT_mabi_ = 1595,                          /* -mabi= */
  OPT_minrt = 1596,                          /* -minrt */
  OPT_mloop = 1597,                          /* -mloop */
  OPT_mmcu_ = 1598,                          /* -mmcu= */
  OPT_mno_relax = 1599,                      /* -mno-relax */
  OPT_n = 1600,                              /* -n */
  OPT_name_sort = 1601,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1602,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1603,              /* -no-integrated-cpp */
  OPT_no_pie = 1604,                         /* -no-pie */
  OPT_nocpp = 1605,                          /* -nocpp */
  OPT_nodefaultlibs = 1606,                  /* -nodefaultlibs */
  OPT_nolibc = 1607,                         /* -nolibc */
  OPT_nophoboslib = 1608,                    /* -nophoboslib */
  OPT_nostartfiles = 1609,                   /* -nostartfiles */
  OPT_nostdinc = 1610,                       /* -nostdinc */
  OPT_nostdinc__ = 1611,                     /* -nostdinc++ */
  OPT_nostdlib = 1612,                       /* -nostdlib */
  OPT_o = 1613,                              /* -o */
  OPT_objects = 1614,                        /* -objects */
  OPT_p = 1615,                              /* -p */
  OPT_pass_exit_codes = 1616,                /* -pass-exit-codes */
  /* OPT_pedantic = 1617, */                 /* -pedantic */
  OPT_pedantic_errors = 1618,                /* -pedantic-errors */
  OPT_pg = 1619,                             /* -pg */
  OPT_pie = 1620,                            /* -pie */
  OPT_pipe = 1621,                           /* -pipe */
  ...
  OPT_quiet = 1634,                          /* -quiet */
  OPT_r = 1635,                              /* -r */
  OPT_remap = 1636,                          /* -remap */
  OPT_reverse_sort = 1637,                   /* -reverse-sort */
  OPT_s = 1638,                              /* -s */
  OPT_save_temps = 1639,                     /* -save-temps */
  OPT_save_temps_ = 1640,                    /* -save-temps= */
  OPT_shared = 1641,                         /* -shared */
  OPT_shared_libgcc = 1642,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1643,               /* -shared-libphobos */
  OPT_size_sort = 1644,                      /* -size-sort */
  /* OPT_specs = 1645, */                    /* -specs */
  OPT_specs_ = 1646,                         /* -specs= */
  OPT_static = 1647,                         /* -static */
  OPT_static_libasan = 1648,                 /* -static-libasan */
  OPT_static_libgcc = 1649,                  /* -static-libgcc */
  OPT_static_libgfortran = 1650,             /* -static-libgfortran */
  OPT_static_libgo = 1651,                   /* -static-libgo */
  OPT_static_liblsan = 1652,                 /* -static-liblsan */
  OPT_static_libmpx = 1653,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1654,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1655,               /* -static-libphobos */
  OPT_static_libstdc__ = 1656,               /* -static-libstdc++ */
  OPT_static_libtsan = 1657,                 /* -static-libtsan */
  OPT_static_libubsan = 1658,                /* -static-libubsan */
  OPT_static_pie = 1659,                     /* -static-pie */
  /* OPT_std_c__03 = 1660, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1661, */                /* -std=c++0x */
  OPT_std_c__11 = 1662,                      /* -std=c++11 */
  OPT_std_c__14 = 1663,                      /* -std=c++14 */
  OPT_std_c__17 = 1664,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1665, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1666, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1667, */                /* -std=c++20 */
  OPT_std_c__2a = 1668,                      /* -std=c++2a */
  OPT_std_c__98 = 1669,                      /* -std=c++98 */
  OPT_std_c11 = 1670,                        /* -std=c11 */
  OPT_std_c17 = 1671,                        /* -std=c17 */
  /* OPT_std_c18 = 1672, */                  /* -std=c18 */
  /* OPT_std_c1x = 1673, */                  /* -std=c1x */
  OPT_std_c2x = 1674,                        /* -std=c2x */
  /* OPT_std_c89 = 1675, */                  /* -std=c89 */
  OPT_std_c90 = 1676,                        /* -std=c90 */
  OPT_std_c99 = 1677,                        /* -std=c99 */
  /* OPT_std_c9x = 1678, */                  /* -std=c9x */
  OPT_std_f2003 = 1679,                      /* -std=f2003 */
  OPT_std_f2008 = 1680,                      /* -std=f2008 */
  OPT_std_f2008ts = 1681,                    /* -std=f2008ts */
  OPT_std_f2018 = 1682,                      /* -std=f2018 */
  OPT_std_f95 = 1683,                        /* -std=f95 */
  OPT_std_gnu = 1684,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1685, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1686, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1687,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1688,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1689,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1690, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1691, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1692, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1693,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1694,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1695,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1696,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1697, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1698, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1699,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1700, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1701,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1702,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1703, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1704, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1705,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1706, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1707, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1708, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1709, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1710, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1711,                     /* -std=legacy */
  OPT_symbol_ = 1712,                        /* -symbol= */
  OPT_symbolic = 1713,                       /* -symbolic */
  OPT_t = 1714,                              /* -t */
  OPT_time = 1715,                           /* -time */
  OPT_time_ = 1716,                          /* -time= */
  OPT_traditional = 1717,                    /* -traditional */
  OPT_traditional_cpp = 1718,                /* -traditional-cpp */
  OPT_tree_stats = 1719,                     /* -tree-stats */
  OPT_trigraphs = 1720,                      /* -trigraphs */
  OPT_type_stats = 1721,                     /* -type-stats */
  OPT_u = 1722,                              /* -u */
  OPT_undef = 1723,                          /* -undef */
  OPT_v = 1724,                              /* -v */
  OPT_version = 1725,                        /* -version */
  OPT_w = 1726,                              /* -w */
  OPT_wrapper = 1727,                        /* -wrapper */
  OPT_x = 1728,                              /* -x */
  OPT_z = 1729,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
